...
namespace logviewer.tests
{
    ...
    internal class TstFileSize
    {
        ...
        [TestCase(2UL * 1024UL * 1024UL * 1024UL * 1024UL * 1024UL, SizeUnit.PBytes, 2.0, "2,00 Pb (2251799813685248 Bytes)")]
        [TestCase(2UL * 1024UL * 1024UL * 1024UL * 1024UL * 1024UL * 1024UL, SizeUnit.EBytes, 2.0, "2,00 Eb (2305843009213693952 Bytes)")]
